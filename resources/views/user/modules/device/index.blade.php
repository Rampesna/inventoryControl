                        ...
                        <div class="col-xl-12 mb-5">
                            <div class="form-group">
                                ...
                                <input id="keyword" type="text" class="form-control form-control-solid filterInput"
                                       placeholder="Cihaz Adı, Marka, Model, Seri No...">
                            </div>
                        </div>
                        <div class="col-xl-3 mb-5">
                            <div class="form-group">
                                <label for="categoryIds">Kategori</label>
                                <select id="categoryIds" class="form-select form-select-solid select2Input"
                                        data-control="select2" data-placeholder="Kategori" multiple></select>
                            </div>
                        </div>
                        <div class="col-xl-3 mb-5">
                            <div class="form-group">
                                <label for="statusIds">Cihaz Durumu</label>
                                <select id="statusIds" class="form-select form-select-solid select2Input"
                                        data-control="select2" data-placeholder="Cihaz Durumu" multiple></select>
                            </div>
                        </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row">
                        <div class="col-xl-12 text-end">
                            <span class="text-muted">Toplam <span id="totalCountSpan">%</span> Kayıttan <span
                                        id="startCountSpan">%</span> - <span id="endCountSpan">%</span> Arasındakiler Gösteriliyor</span>
                        </div>
                    </div>
                </div>
            </div>
