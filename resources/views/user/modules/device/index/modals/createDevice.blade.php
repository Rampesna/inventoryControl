            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                        ...
                        <div class="row mb-5">
                            <div class="col-xl-3 mt-3">
                                <label for="create_device_package_id" class="font-weight-bolder">Cihaz Grubu</label>
                            </div>
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <select id="create_device_package_id" class="form-select form-select-solid select2Input" data-control="select2" data-placeholder="Cihaz Grubu"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5">
                            ...
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <input id="create_device_name" type="text" class="form-control form-control-solid deviceCreateInput">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5">
                            ...
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <input id="create_device_brand" type="text" class="form-control form-control-solid deviceCreateInput">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5">
                            ...
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <input id="create_device_model" type="text" class="form-control form-control-solid deviceCreateInput">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5">
                            ...
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <input id="create_device_serial_number" type="text" class="form-control form-control-solid deviceCreateInput">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5">
                            ...
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <input id="create_device_ip_address" type="text" class="form-control form-control-solid deviceCreateInput">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-xl-3 mt-3">
                                <label for="create_device_description" class="font-weight-bolder">Açıklama</label>
                            </div>
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <textarea id="create_device_description" class="form-control form-control-solid deviceCreateInput" rows="4"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
